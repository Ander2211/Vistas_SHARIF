...
<body>
    ...
    <div class="container">
        <svg xmlns="http://www.w3.org/2000/svg" width="176" height="176" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
    ...
    <div class="container text-center w-100 mt-5">
        <a href="index.php" type="button" class="btn btn-success p-3 w-25 ">Regresar al Menu</a>
    </div>
